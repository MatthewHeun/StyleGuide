...
\begin{itemize}
  ...
  \item LaTeX assumes any period is the end of a sentence and will add an extra space.\\
    ...
    Add a backslash after phrases you don't want ending a sentence.\\
...
\begin{itemize}
  ...
  \item Dollar signs (\$) are unnecessary to format units.\\
        Use "/" not \texttt{\textbackslash frac}.
  \item When two or more units exist in a numerator or denominator
...
\begin{itemize}
  ...
  \item Use subsections with headings to provide
        the reader guidance as they read your report.
